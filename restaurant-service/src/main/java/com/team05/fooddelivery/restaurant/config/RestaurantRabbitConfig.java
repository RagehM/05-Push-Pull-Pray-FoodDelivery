...
public class RestaurantRabbitConfig {
    ...
    @Bean
    MessageConverter restaurantRabbitMessageConverter() {
        return new JacksonJsonMessageConverter();
    }

    @Bean
    RabbitTemplate restaurantRabbitTemplate(
            ConnectionFactory connectionFactory,
            @Qualifier("restaurantRabbitMessageConverter") MessageConverter restaurantRabbitMessageConverter) {
        RabbitTemplate template = new RabbitTemplate(connectionFactory);
        template.setMessageConverter(restaurantRabbitMessageConverter);
        return template;
    }
    ...
    SimpleRabbitListenerContainerFactory rabbitListenerContainerFactory(
        ...
        factory.setMessageConverter(restaurantRabbitMessageConverter);
        return factory;
    }
}
