# M2 Tests — Standalone Pack (Talabat)
...
# ── PostgreSQL ──
export SPRING_DATASOURCE_URL=jdbc:postgresql://localhost:5432/fooddeliverydb
export SPRING_DATASOURCE_USERNAME=postgres
export SPRING_DATASOURCE_PASSWORD=postgres

# ── MongoDB ──
export SPRING_DATA_MONGODB_URI=mongodb://root:rootpass@localhost:27017/fooddeliverymongo?authSource=admin
...
export SPRING_CASSANDRA_KEYSPACE_NAME=fooddeliveryks
...
- `src/test/java/com/testgen/talabat/` — the test files (PublicTests, DP_PatternTests, TestBase, TestAuthHelper)
- `src/test/resources/manifest.json` — your project's discovered structure
- `src/test/resources/theme.json` — Talabat spec constants
